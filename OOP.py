...
# ======================================================================================================================
# 1) Студенты:
student_1 = Student('Ivan', 'Petrov', 'man')
student_1.courses_in_progress += ['Python', 'JS']

student_2 = Student('Sergey', 'Klimov', 'man')
student_2.courses_in_progress += ['Python', 'JS']

student_3 = Student('Svetlana', 'Antilohina', 'female')
student_3.courses_in_progress += ['Python', 'JS']

# 2) Лекторы:
lecturer_1 = Lecturer('Kiril', 'Bravo')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Anton', 'Vasil')
lecturer_2.courses_attached += ['JS']

# 3) Проверяющие:
reviewer_1 = Reviewer('Omar', 'Goldshmidt')
reviewer_1.courses_attached += ['Python', 'JS']

reviewer_2 = Reviewer('Slark', 'Dotovich')
reviewer_2.courses_attached += ['Python', 'JS']
# ----------------------------------------------------------------------------------------------------------------------
# Оценки студентам:
reviewer_1.rate_hw(student_1, 'Python', 10)
reviewer_1.rate_hw(student_1, 'JS', 6)
reviewer_1.rate_hw(student_2, 'Python', 9)
reviewer_1.rate_hw(student_2, 'JS', 7)
reviewer_1.rate_hw(student_3, 'Python', 8)
reviewer_1.rate_hw(student_3, 'JS', 9)

reviewer_2.rate_hw(student_1, 'Python', 5)
reviewer_2.rate_hw(student_1, 'JS', 8)
reviewer_2.rate_hw(student_2, 'Python', 6)
reviewer_2.rate_hw(student_2, 'JS', 10)
reviewer_2.rate_hw(student_3, 'Python', 9)
reviewer_2.rate_hw(student_3, 'JS', 5)
# ----------------------------------------------------------------------------------------------------------------------
# Оценки лекторам:
student_1.rate_lectur(lecturer_1, 'Python', 10)
student_1.rate_lectur(lecturer_2, 'JS', 10)
student_1.rate_lectur(lecturer_1, 'Python', 7)
student_1.rate_lectur(lecturer_2, 'JS', 7)

student_2.rate_lectur(lecturer_1, 'Python', 10)
student_2.rate_lectur(lecturer_2, 'JS', 6)
student_2.rate_lectur(lecturer_1, 'Python', 10)
student_2.rate_lectur(lecturer_2, 'JS', 9)

student_3.rate_lectur(lecturer_1, 'Python', 9)
student_3.rate_lectur(lecturer_2, 'JS', 7)
student_3.rate_lectur(lecturer_1, 'Python', 9)
student_3.rate_lectur(lecturer_2, 'JS', 8)
# ----------------------------------------------------------------------------------------------------------------------
...
print(f"Средняя оценка за домашние задания по всем студентам в рамках курса JS: "
      f"{round(overall_rating_students(students, 'JS'), 2)}")
...
print(f"Средняя оценка за лекции всех лекторов в рамках курса JS: "
      f"{round(overall_rating_lectors(lectors, 'JS'), 2)}")